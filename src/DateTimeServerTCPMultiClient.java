...
public class DateTimeServerTCPMultiClient {
    public static void main(String[] args) throws IOException {
        ...
        if (args.length > 0) {
            if (args.length == 1)
                ...
                System.err.println("Usage: java DateTimeServerTCPMultiClient [<port number>]");
                System.exit(1);
            }
        }

        System.out.println("Hi, I am the DateTimeServerTCPMultiClient TCP server.");
        ...
        try (
            ...
            while (true) {
                ...
                ClientServer clientserver = new DateTimeServerTCPMultiClient.ClientServer(serverSocket.accept());
                clientserver.start();
            }
        } catch (IOException e) {
    ...
    static class ClientServer extends Thread {
        ...
        private String ProcessString(String intext) {
            String outtext = DateTimeServerTCP.getDateTimeString(intext);
            return outtext;
        }
    }
}
